...
public record CustomerKnowledgeChunkingOptions(
    ...
    public static final int DEFAULT_MIN_CHUNK_LENGTH = 200;
    ...
    private static final int MIN_MAX_CHUNK_LENGTH = 300;
    private static final int MAX_MAX_CHUNK_LENGTH = 4_000;
    private static final int MIN_MIN_CHUNK_LENGTH = 0;
    ...
    public static CustomerKnowledgeChunkingOptions normalize(Integer maxChunkLength, Integer minChunkLength,
                                                             Integer overlapLength, Boolean splitByMarkdownHeading,
                                                             Boolean splitByParagraph) {
        ...
        int normalizedMin = clamp(
                minChunkLength == null ? DEFAULT_MIN_CHUNK_LENGTH : minChunkLength,
                MIN_MIN_CHUNK_LENGTH,
                normalizedMax / 2);
        ...
        boolean normalizedParagraphSplit = splitByParagraph == null
                ...
                : splitByParagraph;
        return new CustomerKnowledgeChunkingOptions(
                normalizedMax, normalizedMin, normalizedOverlap, normalizedHeadingSplit, normalizedParagraphSplit);
    }
