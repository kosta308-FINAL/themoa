...
public final class FakeRegionData {
    ...
    public static List<RegionCode> regions() {
        return List.of(
                ...
                new RegionCode(null, "26140", "부산광역시", "서구", "DISTRICT"),
                new RegionCode(null, "27", "대구광역시", null, "PROVINCE"),
                new RegionCode(null, "27110", "대구광역시", "중구", "DISTRICT"),
                new RegionCode(null, "27140", "대구광역시", "동구", "DISTRICT"),
                new RegionCode(null, "27170", "대구광역시", "서구", "DISTRICT"),
                new RegionCode(null, "27200", "대구광역시", "남구", "DISTRICT"),
                new RegionCode(null, "27230", "대구광역시", "북구", "DISTRICT"),
                new RegionCode(null, "27260", "대구광역시", "수성구", "DISTRICT"),
                new RegionCode(null, "27290", "대구광역시", "달서구", "DISTRICT"),
                new RegionCode(null, "27710", "대구광역시", "달성군", "CITY"),
                new RegionCode(null, "27720", "대구광역시", "군위군", "CITY"),
                new RegionCode(null, "28", "인천광역시", null, "PROVINCE"),
                new RegionCode(null, "28140", "인천광역시", "동구", "DISTRICT"),
                new RegionCode(null, "28260", "인천광역시", "서구", "DISTRICT"),
                ...
                new RegionCode(null, "41630", "경기도", "양주시", "CITY"),
                ...
                new RegionCode(null, "42130", "강원특별자치도", "원주시", "CITY"),
