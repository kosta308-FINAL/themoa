...
export const navItems = [
  ...
  { key: 'products', label: '금융상품', icon: 'sparkle' },
  { key: 'policy', label: '정책 지원', icon: 'building' },
  { key: 'spending', label: '소비 가이드', icon: 'chart' },
  { key: 'loan', label: '대출 비교', icon: 'calendar' },
...
export const popularSearches = ['청년 전세자금 대출', '국민내일배움카드', 'ISA 계좌', '청년도약계좌']
...
export const policyRecommendations = [
  { icon: 'building', title: '청년 월세 지원', detail: '월 20만원씩 12개월 지원', status: '신청 가능' },
  { icon: 'user', title: '국가장학금', detail: '연 최대 700만원 지원', status: '신청 가능' },
  { icon: 'check', title: '청년내일채움공제', detail: '2년 만기 시 최대 1,200만원', status: '신청 가능' },
]

export const recentActivity = [
  { icon: 'sparkle', title: '스타벅스 강남점', category: '카페/간식', amount: '-6,200원', time: '오늘 14:30', negative: true },
  { icon: 'building', title: 'KB 국민은행 적금 가입', category: '금융상품', amount: '+500,000원', time: '어제 11:20', negative: false },
]

export const spendingTip = {
  title: 'AI 소비 팁',
  message: '이번 달 커피 소비가 지난 달보다 23% 증가했어요. 월 3만원 절약할 수 있는 방법을 알아볼까요?',
  cta: '팁 보러가기',
}
