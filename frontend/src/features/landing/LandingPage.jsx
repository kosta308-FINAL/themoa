  ...
  return (
    <div className="slide-card">
      ...
      <div className="dp-category-bar">
        <div
          className="cat-seg"
          style={{ width: "38%", background: "#f59e0b" }}
        />
        <div
          className="cat-seg"
          style={{ width: "25%", background: "#4f62e8" }}
        />
        <div
          className="cat-seg"
        ...
        <div
          className="cat-seg"
          style={{ width: "19%", background: "#e5e7eb" }}
        />
      </div>
      <div className="dp-cat-labels">
        <span>
          <i className="cat-dot" style={{ background: "#f59e0b" }} />
          식비 38%
        </span>
        <span>
          <i className="cat-dot" style={{ background: "#4f62e8" }} />
          쇼핑 25%
        </span>
        <span>
          <i className="cat-dot" style={{ background: "#22c55e" }} />
          교통 18%
        </span>
        <span>
          <i className="cat-dot" style={{ background: "#d1d5db" }} />
          기타 19%
        </span>
      </div>
      <div className="dp-divider" />
      ...
      <div className="dp-txn-list">
        {[
          ...
          <div key={i} className="dp-txn">
            ...
            <span className={`dp-txn-amount ${t.pos ? "pos" : "neg"}`}>
              {t.amount}
            </span>
          </div>
        ))}
      ...
      <div className="container hero-split">
        ...
        <div className="hero-left">
          <div className="hero-badge">
            <span className="badge-dot" />내 월급, 내가 설계하는 소비
          </div>
          ...
          <p className="hero-desc">
            Themore는 급여와 목표 기반으로 하루 소비 한도를 자동 계산하고,
            <br />
